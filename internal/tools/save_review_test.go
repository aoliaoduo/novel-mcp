...
func TestSaveReviewPersistsContractAssessment(t *testing.T) {
	...
	args, err := json.Marshal(map[string]any{
		"chapter":    3,
		"scope":      "chapter",
		"dimensions": []map[string]any{{"dimension": "consistency", "score": 85, "comment": "基本一致"}, {"dimension": "character", "score": 82, "comment": "人设稳定"}, {"dimension": "pacing", "score": 78, "comment": "略慢"}, {"dimension": "continuity", "score": 84, "comment": "连贯"}, {"dimension": "foreshadow", "score": 80, "comment": "正常"}, {"dimension": "hook", "score": 76, "comment": "钩子一般"}, {"dimension": "aesthetic", "score": 81, "comment": "语言基本成立"}},
...
func TestSaveReviewKeepsModelDefinedDimension(t *testing.T) {
	...
	args, err := json.Marshal(map[string]any{
		...
		"scope":   "chapter",
		"dimensions": []map[string]any{{
			"dimension": "dialogue_subtext", "score": 85, "comment": "潜台词仍可加强",
		}},
		"issues":  []map[string]any{},
		"verdict": "accept",
		"summary": "ok",
	...
	if d := review.Dimension("dialogue_subtext"); d == nil || d.Comment != "潜台词仍可加强" {
